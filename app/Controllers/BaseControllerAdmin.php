...
use App\Models\PostingDiajukanKategoriModel;
...
abstract class BaseControllerAdmin extends Controller
{
        ...
        protected PostingKategoriModel $postingKategoriModel;
        protected PostingDiajukanModel $postingDiajukanModel;
        protected PostingDiajukanKategoriModel $postingDiajukanKategoriModel;
        ...
        public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger)
        {
                ...
                $this->postingDiajukanKategoriModel = new PostingDiajukanKategoriModel();
                ...
                // Bahasa
                // TODO: Localization in non user context environment such as Login
