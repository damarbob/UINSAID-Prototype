...
class BeritaModel extends \CodeIgniter\Model
{
    ...
    public function refactorFeaturedImages()
    {
        ...
        foreach ($berita as $b) {
            dd($b['id']);
            $firstImage = $this->extract_first_image($b['konten'], base_url('assets/img/icon-notext.png'), false);
            if (!$firstImage) {
                dd('WHAT');
            }
            $this->save(
    ...
    public function updateFeaturedImages()
    {
        ...
        foreach ($berita as $item) {
            $firstImage = $this->extract_first_image($item['konten'], base_url('assets/img/icon-notext.png'), false);
            if ($firstImage) {
