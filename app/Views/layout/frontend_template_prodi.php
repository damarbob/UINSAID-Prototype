    ...
    <div class="container px-4 px-sm-5">
      ...
      <div class="collapse navbar-collapse mb-2 mb-sm-0" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-4 fw-bold">
          ...
          <!-- Link Profil -->
          <li class="nav-item">
            <a data-mdb-ripple-init class="nav-link <?= $currentRoute == url_to('profil_prodi') ? "active" : "" ?>" href="<?= url_to('profil_prodi') ?>">Profil</a>
          </li>

          <!-- Link Akademik -->
          <li class="nav-item">
            <a data-mdb-ripple-init class="nav-link" href="#">Akademik</a>
          </li>
          <!-- Link Kerjasama -->
          <li class="nav-item">
