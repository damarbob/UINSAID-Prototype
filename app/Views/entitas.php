...
<div class="container mt-navbar pt-5">
            ...
            <div class="col-lg-6 col-xl-3">
                ...
                <div class="card shadow" mdb-ripple-init>
                    <div class="ratio ratio-4x3">
                        <img src="<?= $e['gambar_sampul'] ?>" class="card-img-top object-fit-cover" alt="..." />
                    </div>
                    <div class="card-body text-start">
                        <a href="<?= base_url() ?>berita/<?= $e['slug'] ?>">
    ...
    <div class="row mt-5">
        <!-- Paginasi -->
        <div class="d-flex">
            <?= $pagerEntitas->links('berita', 'pager') ?>
        </div>
        <!-- Akhir paginasi -->
    </div>
</div>
