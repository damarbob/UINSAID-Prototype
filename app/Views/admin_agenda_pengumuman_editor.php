...
<script>
    tinymce.init({
        ...
        plugins: [
            ...
            'wordcount', 'dsmgallery', 'dsmfileinsert', 'code', 'csvtohtml'
        ],
        ...
        images_upload_url: '<?= base_url('/admin/posting/unggah-gambar') ?>', // TODO: Create a function in GaleryAdmin to receive image from Tiny
