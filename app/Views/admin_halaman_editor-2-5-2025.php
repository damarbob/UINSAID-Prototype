...
<form action="<?= base_url('/admin/halaman/simpan/' . (isset($halaman['id']) ? $halaman['id'] : '')); ?>" method="post" enctype="multipart/form-data">
    <div class="row mb-5">
        ...
        <div class="col-lg-8">
            ...
            <input type="hidden" name="id_komponen" value='<?= !empty($halamanKomponen) ? json_encode($halamanKomponen) : '[]'; ?>'>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
                ...
                success: function(response) {
                    ...
                    if (response['data']) {
                        ...
                        if (meta && meta.length > 0) {
                            ...
                            const metaField = extractMetaFieldFromContent(content); // Extract meta field from content
        ...
        function getKomponenMetaById(jsonString, id) {
            try {
