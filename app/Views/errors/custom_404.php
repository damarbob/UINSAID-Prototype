...
<div class="vh">
    <div class="wrap">
        ...
        <a href="<?= base_url() ?>" class="btn btn-light"><i class="bi bi-house me-2"></i>Beranda</a>
        <a href="<?= base_url('berita') ?>" class="btn btn-light"><i class="bi bi-newspaper me-2"></i>Berita</a>
    </div>
</div>