    ...
    <html>
        <head>
            ...
            .asw-menu-btn {
                ...
                display: flex;
                cursor: pointer;
                /* border: 3px solid var(--mdb-body-bg)!important; */
        ...
        <body>
            <div class="asw-widget">
                <a href="https://accessibility-widget.pages.dev" target="_blank" class="asw-menu-btn" title="Open Accessibility Menu" role="button" aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" style="fill:var(--mdb-body-bg)" viewBox="0 0 24 24" width="30px" height="30px">
    ...
    a((e = $($({}, e), t))),
      (function (t) {
        var e,
          ...
          s,
          r = t.position,
          l = void 0 === r ? "bottom-right" : r, // Set position
          c = t.offset,
          g = void 0 === c ? [16, 96] : c, // Set margin
